...
//         name: 'Go Cache',
//         type: .goCache,
//         cacheFolders: [homePath!.join('.go_cache')],
//         totalCacheSize: getFolderSize(Directory(homePath.join('.go_cache'))),
//       ),
//     );
//     projects.add(
//       ProjectInfo(
//         name: 'Linux Cache',
//         type: .linuxCache,
//         cacheFolders: [homePath.join('.cache')],
//         totalCacheSize: getFolderSize(Directory(homePath.join('.cache'))),
//       ),
//     );
//     projects.add(
//       ProjectInfo(
//         name: 'Gradle Cache',
//         type: .gradleCaches,
//         cacheFolders: [homePath.join('.gradle').join('caches')],
//         totalCacheSize: getFolderSize(
//           Directory(homePath.join('.gradle').join('caches')),
//         ),
//       ),
//     );
